...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.verifier-container {
  max-width: 70%;
  margin-left: 20px;
}
...
.checked {
outline: 2px solid rgb(30, 229, 213);
opacity: 1;
}
...
/* .visa {
  background-image: url(../img/visa-curved.png);
}
.mastercard {
  background-image: url(../img/mastercard-curved.png);
}
.american-express {
  background-image: url(../img/american-express-straight.png);
}
.mir {
  background-image: url(../img/icons8-mir-96.png);
}
.jcb {
...
.discover {
  background-image: url(../img/discover-straight.png);
} */
`, ""]);
// Exports
...
;// CONCATENATED MODULE: ./src/js/paymentSystemIdentifier.js
function paymentSystemIdentifier(card) {
...
;// CONCATENATED MODULE: ./src/js/domInteraction.js
